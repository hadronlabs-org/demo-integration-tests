...
use example_base::state::pump::{Config, CONFIG, ICA, ICA_ID};
use example_helpers::answer::response;
...
const CONTRACT_NAME: &str = concat!("crates.io:example-contracts__", env!("CARGO_PKG_NAME"));
