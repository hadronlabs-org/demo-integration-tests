...
import { ExamplePump } from '../generated/contractLib';
import {
  QueryClient,
  StakingExtension,
  BankExtension,
...
const ExamplePumpClass = ExamplePump.Client;
...
describe('Pump-Multi', () => {
  const context: {
    ...
    contractClientGaia?: InstanceType<typeof ExamplePumpClass>;
    contractClientLSM?: InstanceType<typeof ExamplePumpClass>;
    account?: AccountData;
  ...
  it('instantiate', async () => {
    ...
    );
    {
      ...
      context.contractClientGaia = new ExamplePump.Client(
        client,
    ...
    }
    {
      ...
      expect(instantiateRes.contractAddress).toHaveLength(66);
      context.contractAddress = instantiateRes.contractAddress;
      context.contractClientLSM = new ExamplePump.Client(
        client,
        context.contractAddress,
      );
    }
